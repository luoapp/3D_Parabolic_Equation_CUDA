...
spec_filename=sprintf('sw06_pe_plot_spec_broadband_moving_thomson.mat');
...
if exist(spec_filename,'file')
    ...
    datadir = sprintf('../mat/pe_result/moving/thomson/');
    ...
    for ix_sec = 1:length(duration_sec)
        ...
        for ix_freq = 1:length(freq)
            file=dir(sprintf('%s*freq_%d_%s_thomson.mat',...
